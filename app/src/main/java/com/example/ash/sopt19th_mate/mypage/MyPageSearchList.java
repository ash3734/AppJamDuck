...
/**
 * Created by dldud on 2016-12-31.
 */

public class MyPageSearchList {
    int s_id;
    String name;
    String album_name;
    String title_song;
    ...
    public MyPageSearchList(String album_name, String bg_img1, String bg_img2, String main_img, String name, int s_id, String title_song) {
