package com.example.ash.sopt19th_mate.astuetz;
...
public class PagerSlidingTabStrip  extends HorizontalScrollView {
    ...
    private int indicatorColor = Color.parseColor("#FF7D8F");
    ...
    private int tabTextColor = 0xFFFF7D8F;
    ...
    //private int tadteadt = R.drawable.
    //R.drawable.
    //R.drawable.
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        //a.getRe
        //R.styleable.PagerSlidingTabStrip_pstsTabBack
        a.recycle();
    ...
    public void setViewPager(ViewPager pager) {
        this.pager = pager;
        this.pager.setId(IdGen.generateViewId());
